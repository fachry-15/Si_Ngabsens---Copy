...
// Pastikan Anda memiliki ApiSettingsModal di path ini
import ApiSettingsModal from '@/components/ApiSettingsModal';
// Pastikan Anda memiliki service dan store di path ini
import { authService } from '@/services/authService';
import { authStore } from '@/store/authStore';
import { Stack } from 'expo-router'; // Import Stack

// --- Font Definition for Consistency (Asumsi font Fredoka sudah dimuat) ---
const FONT = {
...
export default function LoginScreen() {
    ...
    const handleContinue = async () => {
        if (step === 'nip' && nip.trim()) {
            ...
            try {
                ...
                // Log error detail jika diperlukan
    ...
    return (
        <>
            {/* Menyembunyikan header bawaan Stack Navigator */}
            ...
            <SafeAreaView style={styles.container}>
                ...
                >
                    ...
                    >
                        {/* Header Illustration & Welcome Text */}
                        ...
                        <View style={styles.loginCard}>
                            <View style={styles.cardHeader}>
                                ...
                                {step === 'password' ? <View style={styles.backButton} /> : <View style={styles.backButton} />}
                            </View>
...
const styles = StyleSheet.create({
    container: {
        flex: 1,
        backgroundColor: '#F5F7FA', // Background umum light grey
    },
    keyboardView: {
        flex: 1,
    },
    ...
    // --- Header Illustration (Modernized) ---
    illustrationContainer: {
        height: 260, // Sedikit lebih ramping
    ...
    overlay: {
        ...
        backgroundColor: 'rgba(43, 85, 151, 0.88)', // Biru tua yang dominan
    },
    headerTextContainer: {
        position: 'absolute',
        bottom: 30,
    ...
    // --- Login Card (Floating/Modern) ---
    loginCard: {
        flex: 1,
        backgroundColor: '#FFFFFF',
        borderTopLeftRadius: 36, // Lekukan yang lebih besar
        borderTopRightRadius: 36,
        marginTop: -30, // Tumpang tindih lebih banyak dengan header
    ...
    inputWrapper: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: '#F9FAFB', // Background input sangat ringan
        borderRadius: 12,
    ...
    continueButton: {
        ...
        backgroundColor: '#10B981', // Warna aksi (Hijau)
        borderRadius: 12,
        paddingVertical: 16,
        gap: 10,
        // Shadow menonjol
